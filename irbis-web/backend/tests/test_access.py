...
def main():
    ...
    seeding_checks()
    flk_checks()
    for _m in ('test_phpass',
               'test_pft', 'test_authority', 'test_authority_seam', 'test_notifications',
               ...
               'test_inforost', 'test_sru', 'test_webhooks', 'test_authority_control',
               'test_search_index',
               ...
               'test_acq_bp_routes', 'test_circ_routes', 'test_cataloging_gbl',
               'test_social',
