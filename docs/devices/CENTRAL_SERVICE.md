...
- Лог/обновление/настройки: `ExternalLogAdd/Get`, `upd_IsUpdateAvailable`, `upd_Update`(zip), `upd_UpdateInfoGet`, `SettingsGet/Modify`, `ManualGet`(pdf), `ColorsGet`, `ServicesGet`.
