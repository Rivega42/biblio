...
| **Сканирование / DAM / оцифровка** | edge+cloud | захват со сканеров (TWAIN/планшет/книжный/планетарный) на edge → DAM (мастер+деривативы, fixity) → OCR → ИИ-теги → IIIF; связь с записью (951/953/955) | модуль |
| **Help-портал / AI-навигатор** | cloud | docs-as-site + Cmd+K-поиск + ассистент: навигация на нужный раздел/экран и подсветка; та же связка — в приложении | модуль |
