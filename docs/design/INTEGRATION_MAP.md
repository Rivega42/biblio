...
|---|---|---|
| ✅ preserved (дизайн + код) | **32** | ~54% |
| 🟡 designed-not-wired | **6** | ~10% |
| ❌ at-risk-of-loss | **21** | ~36% |
| **Итого рёбер** | **59** | 100% |
