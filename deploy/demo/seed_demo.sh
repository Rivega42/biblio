...
#   3) демо-читатели БЕЗ реальных ПДн — создаются как обычные учётные записи
...
echo "[1/3] Провижининг демо-арендатора (схема + словари + админ + план)…"
...
echo "[2/3] Загрузка демо-каталога в own-store…"
...
# ── Шаг 3: демо-читатели БЕЗ реальных ПДн ─────────────────────────────────────
...
echo "[3/3] Создание демо-читателей (синтетические данные, без реальных ПДн)…"
